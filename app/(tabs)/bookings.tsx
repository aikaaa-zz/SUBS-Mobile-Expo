...
const styles = StyleSheet.create({
  ...
  chipText: { fontSize: FontSize.sm, color: Colors.textMuted, fontFamily: 'Inter_500Medium' },
  chipTextActive: { color: Colors.white, fontFamily: 'Inter_500Medium' },
  ...
  businessName: { fontSize: FontSize.xl, fontFamily: 'Inter_600SemiBold', color: Colors.textDark, flex: 1, marginRight: 8 },
  statusBadge: { paddingHorizontal: 12, paddingVertical: 4, borderRadius: BorderRadius.full },
  statusText: { fontSize: FontSize.xs, fontFamily: 'Inter_600SemiBold', textTransform: 'capitalize' },
  detailRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 6 },
  detailLabel: { fontSize: FontSize.md, color: Colors.textMuted, fontFamily: 'Inter_500Medium' },
  detailValue: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textDark, flex: 1 },
  notesRow: { marginBottom: 6 },
  notesText: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textDark, marginTop: 4 },
  ...
  policyWarningText: { fontSize: FontSize.xs, color: '#92400e', fontFamily: 'Inter_500Medium' },
  ...
  cancelBtnText: { color: Colors.errorRed, fontFamily: 'Inter_600SemiBold', fontSize: FontSize.md },
  ...
  rescheduleBtnText: { color: Colors.primaryOrange, fontFamily: 'Inter_600SemiBold', fontSize: FontSize.md },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 20 },
  modalContent: { backgroundColor: Colors.bgWhite, borderRadius: BorderRadius.xl, padding: 24 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  modalTitle: { fontSize: FontSize.xxl, fontFamily: 'Inter_700Bold', color: Colors.textDark },
  modalDesc: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textMuted, marginBottom: 16, lineHeight: 22 },
  formLabel: { fontSize: FontSize.md, fontFamily: 'Inter_500Medium', color: Colors.textDark, marginBottom: 8 },
  textarea: {
    backgroundColor: Colors.bgLight, borderWidth: 1, borderColor: Colors.borderColor,
    borderRadius: BorderRadius.md, padding: 12, fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textDark,
  ...
  dateInputText: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textDark },
  ...
  keepBtnText: { color: Colors.textMuted, fontFamily: 'Inter_600SemiBold', fontSize: FontSize.md },
