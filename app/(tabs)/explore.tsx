...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: FontSize.lg, fontFamily: 'Inter_400Regular', color: Colors.textDark, padding: 0 },
  ...
  resultsText: { fontSize: FontSize.sm, fontFamily: 'Inter_400Regular', color: Colors.textMuted },
  errorBanner: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    backgroundColor: '#fef2f2', borderWidth: 1, borderColor: '#fecaca',
    borderRadius: BorderRadius.lg, padding: 12, marginHorizontal: 20, marginBottom: 8,
  },
  errorText: { flex: 1, color: Colors.errorRed, fontSize: FontSize.md, fontFamily: 'Inter_400Regular' },
  retryBtn: { backgroundColor: Colors.errorRed, paddingHorizontal: 16, paddingVertical: 8, borderRadius: BorderRadius.md },
  retryBtnText: { color: Colors.white, fontSize: FontSize.sm, fontFamily: 'Inter_600SemiBold' },
  ...
  businessName: { fontSize: FontSize.xl, fontFamily: 'Inter_600SemiBold', color: Colors.textDark, marginBottom: 4 },
  ...
  categoryTagText: { fontSize: FontSize.xs, color: Colors.primaryOrange, fontFamily: 'Inter_600SemiBold' },
  ...
  businessDesc: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textMuted, marginBottom: 8, lineHeight: 20 },
  businessEmail: { fontSize: FontSize.sm, fontFamily: 'Inter_400Regular', color: Colors.textMuted },
});
