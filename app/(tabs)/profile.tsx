...
const styles = StyleSheet.create({
  ...
  userName: { fontSize: FontSize.xxl, fontFamily: 'Inter_700Bold', color: Colors.textDark, marginBottom: 4 },
  emailRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 },
  userEmail: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textMuted },
  accountBadge: { backgroundColor: Colors.lightOrangeBg, paddingHorizontal: 16, paddingVertical: 4, borderRadius: BorderRadius.full },
  accountBadgeText: { fontSize: FontSize.sm, color: Colors.primaryOrange, fontFamily: 'Inter_600SemiBold' },
  ...
  menuContent: { flex: 1 },
  menuLabel: { fontSize: FontSize.lg, fontFamily: 'Inter_600SemiBold', color: Colors.textDark },
  menuDesc: { fontSize: FontSize.sm, fontFamily: 'Inter_400Regular', color: Colors.textMuted, marginTop: 2 },
  ...
  logoutText: { fontSize: FontSize.lg, fontFamily: 'Inter_600SemiBold', color: Colors.errorRed },
  appInfo: { alignItems: 'center', padding: 24, marginBottom: 20 },
  appInfoText: { fontSize: FontSize.sm, fontFamily: 'Inter_400Regular', color: Colors.textMuted },
  ...
  errorText: { color: Colors.errorRed, fontSize: FontSize.md, fontFamily: 'Inter_400Regular', textAlign: 'center' },
  formLabel: { fontSize: FontSize.md, fontFamily: 'Inter_500Medium', color: Colors.textDark, marginBottom: 8 },
  input: { backgroundColor: Colors.bgLight, borderWidth: 1, borderColor: Colors.borderColor, borderRadius: BorderRadius.md, paddingHorizontal: 16, paddingVertical: 12, fontSize: FontSize.lg, fontFamily: 'Inter_400Regular', color: Colors.textDark, marginBottom: 16 },
  ...
  cancelBtnText: { color: Colors.textMuted, fontFamily: 'Inter_600SemiBold' },
  ...
  saveBtnText: { color: Colors.white, fontFamily: 'Inter_600SemiBold' },
});
