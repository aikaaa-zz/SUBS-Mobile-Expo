...
const styles = StyleSheet.create({
  ...
  paymentInfo: { flex: 1 },
  paymentType: { fontSize: FontSize.lg, fontFamily: 'Inter_600SemiBold', color: Colors.textDark },
  ...
  amountLabel: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textMuted },
  amountValue: { fontSize: FontSize.xl, fontFamily: 'Inter_700Bold', color: Colors.textDark },
  methodRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  methodLabel: { fontSize: FontSize.md, fontFamily: 'Inter_400Regular', color: Colors.textMuted },
  methodBadge: { backgroundColor: Colors.bgLight, paddingHorizontal: 10, paddingVertical: 2, borderRadius: BorderRadius.full },
  methodText: { fontSize: FontSize.xs, fontFamily: 'Inter_700Bold', color: Colors.textDark },
});
